...
public class MainActivity extends AppCompatActivity {
    ...
    private void getContent() {
        ...
        try {
            ...
            String start = "<td class=\"photo_column photo_column-top\">";
            String finish = "<td class=\"\">Классическая музыка</td>";
            ...
            Pattern patternName = Pattern.compile("alt=\"(.*?)\" title");
    ...
    private void generateQuestion() {
        ...
        getNumberOfRightAnswer = (int) (Math.random() * buttons.size());
    }
    ...
    public void onClickAnswer(View view) {
        ...
        if (Integer.parseInt(tag) == getNumberOfRightAnswer) {
